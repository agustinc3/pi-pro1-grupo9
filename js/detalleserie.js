...
//api
let url = `https://api.themoviedb.org/3/tv/${idPeli}?api_key=062d3ce7ea9819367da90034f22a527a&language=en-US`;
...
fetch(url)
    ...
    .then(function (data) {
        ...
        estreno.innerText = 'Release: ' + data.first_air_date;
...
URLproveedor = `https://api.themoviedb.org/3/tv/${idPeli}/watch/providers?api_key=062d3ce7ea9819367da90034f22a527a`
